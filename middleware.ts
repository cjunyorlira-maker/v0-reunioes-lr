...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|api/pluga|api/kommo|api/n8n|api/webhook|api/atendimentos/processar|api/atendimentos/upload|api/atendimentos/auth|api/atendimentos/blob-upload|api/vendas|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
}
