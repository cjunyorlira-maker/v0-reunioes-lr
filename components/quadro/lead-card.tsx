            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              {lead.remarcado && (
                <button
                  ...
                  className="text-[10px] font-semibold px-2 py-0.5 rounded bg-[rgba(243,190,255,0.1)] text-[#f3beff] border border-[rgba(243,190,255,0.2)] hover:bg-[rgba(243,190,255,0.2)]"
                >
                  REMARCADO
                </button>
              )}
              ...
              {lead.retorno && (
                <span className="text-[10px] font-semibold px-2 py-0.5 rounded bg-cyan-500/15 text-cyan-400 border border-cyan-500/25">
                  RETORNO
                </span>
              )}
            </div>
